...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0529_2343/checkpoints/checkpoint_best_iter_145/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0529_2343/checkpoints/checkpoint_best_iter_145/policies/policy_evader")
