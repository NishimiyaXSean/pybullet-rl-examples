...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0610_2025/checkpoints/checkpoint_best_iter_1711/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0610_2025/checkpoints/checkpoint_best_iter_1711/policies/policy_evader")
