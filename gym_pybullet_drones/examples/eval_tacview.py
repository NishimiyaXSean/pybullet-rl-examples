...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0604_1031/checkpoints/checkpoint_best_iter_706/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0604_1031/checkpoints/checkpoint_best_iter_706/policies/policy_evader")
