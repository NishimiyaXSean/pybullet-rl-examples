...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0527_2109/checkpoints/checkpoint_best_iter_376/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0527_2109/checkpoints/checkpoint_best_iter_376/policies/policy_evader")
