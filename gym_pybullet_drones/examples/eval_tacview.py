...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0527_1720/checkpoints/checkpoint_best_iter_137/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0527_1720/checkpoints/checkpoint_best_iter_137/policies/policy_evader")
