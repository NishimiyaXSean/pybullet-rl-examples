...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0606_0923/checkpoints/checkpoint_best_iter_507/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0606_0923/checkpoints/checkpoint_best_iter_507/policies/policy_evader")
