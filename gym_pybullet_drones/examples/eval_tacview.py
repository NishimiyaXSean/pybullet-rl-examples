...
def evaluate_and_record():
    ...
    attacker_dir = os.path.abspath("./marl_runs/mappo_run_0527_1509/checkpoints/checkpoint_000100/policies/policy_attacker")
    evader_dir = os.path.abspath("./marl_runs/mappo_run_0527_1509/checkpoints/checkpoint_000100/policies/policy_evader")
